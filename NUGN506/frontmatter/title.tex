...
{\HUGE Nuclear Fuel Cycle }\\[4mm]
{\Large \textit{NUGN506 - Homework}}\\
...
\vspace{11mm}
\begin{minipage}{10cm}
Homework submitted for the Nuclear Fuel Cycle class at the Colorado School of Mines.
\end{minipage}\\
\vspace{9mm}
{\large\textsc{Fall 2017}}
\vspace{12mm}
\end{center}
\end{adjustwidth*}
\end{SingleSpace}

...
{\HUGE Atomic and nuclear structures and reactions }\\[4mm]
{\Large \textit{Chapter 1}}\\
...
\vspace{11mm}
\begin{minipage}{10cm}
A homework submitted for the Nuclear Reactor Thermal-Hydraulics class at the Colorado School of Mines.
\end{minipage}\\
\vspace{9mm}
{\large\textsc{January 16, 2016}}
\vspace{12mm}
\end{center}
\end{adjustwidth*}
\end{SingleSpace}
